...
export const SIGNS: Readonly<Record<string, SignDefinition>> = Object.freeze({
  ...
  NAME: {
    ...
    dominant: [
      ...
      { atMs: 180, location: 'CENTRE_MID', handshape: 'H', orientation: 'FINGERS_ACROSS_DOWN' },
      { atMs: 300, location: 'CENTRE_LOW', handshape: 'H', orientation: 'FINGERS_ACROSS_DOWN' },
      { atMs: 420, location: 'CENTRE_MID', handshape: 'H', orientation: 'FINGERS_ACROSS_DOWN' },
      { atMs: 540, location: 'CENTRE_LOW', handshape: 'H', orientation: 'FINGERS_ACROSS_DOWN' },
      { atMs: 720, location: 'CENTRE_LOW', handshape: 'H', orientation: 'FINGERS_ACROSS_DOWN' },
    ],
    nonDominant: [
      { atMs: 0, location: 'CENTRE_LOW', handshape: 'H', orientation: 'FINGERS_FORWARD' },
      { atMs: 720, location: 'CENTRE_LOW', handshape: 'H', orientation: 'FINGERS_FORWARD' },
    ],
  },
