...
export const SIGNS: Readonly<Record<string, SignDefinition>> = Object.freeze({
  HELLO: {
    ...
    dominant: [
      ...
      { atMs: 180, location: 'TEMPLE', handshape: 'FLAT', orientation: 'ANGLED_OUT' },
      { atMs: 300, location: 'TEMPLE', handshape: 'FLAT', orientation: 'ANGLED_OUT' },
  ...
  MY: {
    ...
    dominant: [
      ...
      { atMs: 300, location: 'CHEST', handshape: 'FLAT', orientation: 'PALM_IN' },
      { atMs: 560, location: 'CHEST', handshape: 'FLAT', orientation: 'PALM_IN' },
    ],
  },
  ...
  NAME: {
    ...
    durationMs: 720, strokeStartMs: 120, strokeEndMs: 640, provenance: PLACEHOLDER,
    dominant: [
      { atMs: 0, location: 'NEUTRAL', handshape: 'H', orientation: 'PALM_DOWN' },
      { atMs: 180, location: 'CENTRE_MID', handshape: 'H', orientation: 'PALM_DOWN' },
      { atMs: 300, location: 'CENTRE_LOW', handshape: 'H', orientation: 'PALM_DOWN' },
      { atMs: 420, location: 'CENTRE_MID', handshape: 'H', orientation: 'PALM_DOWN' },
      { atMs: 540, location: 'CENTRE_LOW', handshape: 'H', orientation: 'PALM_DOWN' },
      { atMs: 720, location: 'CENTRE_LOW', handshape: 'H', orientation: 'PALM_DOWN' },
    ],
    nonDominant: [
      { atMs: 0, location: 'CENTRE_LOW', handshape: 'H', orientation: 'PALM_ACROSS' },
      { atMs: 720, location: 'CENTRE_LOW', handshape: 'H', orientation: 'PALM_ACROSS' },
    ],
  },
  ...
  'THANK-YOU': {
    ...
    dominant: [
      ...
      { atMs: 200, location: 'MOUTH', handshape: 'FLAT', orientation: 'PALM_IN' },
      { atMs: 320, location: 'MOUTH', handshape: 'FLAT', orientation: 'PALM_IN' },
  ...
  ME: {
    ...
    dominant: [
      ...
      { atMs: 240, location: 'CHEST', handshape: 'POINT', orientation: 'PALM_ACROSS' },
      { atMs: 440, location: 'CHEST', handshape: 'POINT', orientation: 'PALM_ACROSS' },
    ],
  },
  ...
  PLEASE: {
    ...
    dominant: [
      { atMs: 0, location: 'NEUTRAL', handshape: 'FLAT', orientation: 'PALM_IN' },
      { atMs: 200, location: 'CHEST', handshape: 'FLAT', orientation: 'PALM_IN' },
      { atMs: 360, location: 'CENTRE_MID', handshape: 'FLAT', orientation: 'PALM_IN' },
      { atMs: 520, location: 'CHEST', handshape: 'FLAT', orientation: 'PALM_IN' },
      { atMs: 700, location: 'CHEST', handshape: 'FLAT', orientation: 'PALM_IN' },
    ],
  },
  ...
  SORRY: {
    ...
    dominant: [
      ...
      { atMs: 200, location: 'CHEST', handshape: 'A', orientation: 'PALM_IN' },
      { atMs: 360, location: 'CENTRE_MID', handshape: 'A', orientation: 'PALM_IN' },
      { atMs: 520, location: 'CHEST', handshape: 'A', orientation: 'PALM_IN' },
      { atMs: 700, location: 'CHEST', handshape: 'A', orientation: 'PALM_IN' },
    ],
  },
  ...
  GOOD: {
    ...
    nonDominant: [
      ...
      { atMs: 600, location: 'CENTRE_LOW', handshape: 'FLAT', orientation: 'PALM_UP' },
    ],
  },
  ...
  LOVE: {
    ...
    dominant: [
      ...
      { atMs: 300, location: 'CHEST', handshape: 'S', orientation: 'PALM_IN' },
      { atMs: 620, location: 'CHEST', handshape: 'S', orientation: 'PALM_IN' },
    ],
    nonDominant: [
      { atMs: 0, location: 'NEUTRAL', handshape: 'S', orientation: 'PALM_IN' },
  ...
  LEARN: {
    ...
    dominant: [
      ...
      { atMs: 620, location: 'FOREHEAD', handshape: 'FLAT_O', orientation: 'PALM_IN' },
      { atMs: 700, location: 'FOREHEAD', handshape: 'FLAT_O', orientation: 'PALM_IN' },
    ],
    nonDominant: [
      { atMs: 0, location: 'CENTRE_LOW', handshape: 'FLAT', orientation: 'PALM_UP' },
      { atMs: 700, location: 'CENTRE_LOW', handshape: 'FLAT', orientation: 'PALM_UP' },
    ],
  },
  ...
  DEAF: {
    ...
    dominant: [
      ...
      { atMs: 240, location: 'EAR', handshape: 'POINT', orientation: 'PALM_ACROSS' },
      { atMs: 520, location: 'MOUTH', handshape: 'POINT', orientation: 'PALM_ACROSS' },
      { atMs: 640, location: 'MOUTH', handshape: 'POINT', orientation: 'PALM_ACROSS' },
    ],
  },
  ...
  HELP: {
    ...
    durationMs: 620, strokeStartMs: 110, strokeEndMs: 560, provenance: PLACEHOLDER,
    dominant: [
      { atMs: 0, location: 'NEUTRAL_LOW', handshape: 'A', orientation: 'PALM_ACROSS' },
      { atMs: 260, location: 'CENTRE_LOW', handshape: 'A', orientation: 'PALM_ACROSS' },
      { atMs: 520, location: 'CENTRE_MID', handshape: 'A', orientation: 'PALM_ACROSS' },
      { atMs: 620, location: 'CENTRE_MID', handshape: 'A', orientation: 'PALM_ACROSS' },
    ],
    nonDominant: [
      { atMs: 0, location: 'CENTRE_LOW', handshape: 'FLAT', orientation: 'PALM_UP' },
      { atMs: 260, location: 'CENTRE_LOW', handshape: 'FLAT', orientation: 'PALM_UP' },
      { atMs: 520, location: 'CENTRE_MID', handshape: 'FLAT', orientation: 'PALM_UP' },
  ...
  SIGN: {
    ...
    nonDominant: [
      ...
      { atMs: 240, location: 'NEUTRAL', handshape: 'POINT', orientation: 'PALM_IN' },
      { atMs: 480, location: 'NEUTRAL_HIGH', handshape: 'POINT', orientation: 'PALM_IN' },
      { atMs: 720, location: 'NEUTRAL', handshape: 'POINT', orientation: 'PALM_IN' },
    ],
  },
  ...
  RIGHT_CORRECT: {
    ...
    nonDominant: [
      { atMs: 0, location: 'CENTRE_LOW', handshape: 'POINT', orientation: 'PALM_ACROSS' },
      { atMs: 560, location: 'CENTRE_LOW', handshape: 'POINT', orientation: 'PALM_ACROSS' },
    ],
  },
